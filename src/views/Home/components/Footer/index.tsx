...
const Footer = () => {
  return (
    <div className="my-[120px] flex w-full justify-center ">
      <div
        style={{
          background: 'linear-gradient(93deg, rgba(21,93,240,1) 10%, rgba(7,7,156,1) 70%)',
        }}
        className="flex  h-fit w-[80%] flex-col items-center justify-center rounded-[20px] sm:flex-col md:flex-col lg:flex-row"
      >
